const translations = {
    'en': {
        ...
        time_out: 'Time Out',
        missing_trade_no: 'Missing order parameter ',
    ...
    'km': { // Cambodian (Khmer)
        ...
        time_out: 'ផុតកំណត់',
        missing_trade_no: 'បាត់ប៉ារ៉ាម៉ែត្រ ',
    ...
    'th': { // Thai
        ...
        receive_name: 'ชื่อบัญชี',
        receive_account: 'หมายเลขบัญชี',
        order_remark: 'หมายเหตุ',
        ...
        time_out: 'หมดเวลา',
        missing_trade_no: 'ขาดพารามิเตอร์หมายเลขคำสั่งซื้อ ',
    ...
    'my': { // Burmese
        ...
        receive_name: 'အကောင့်အမည်',
        receive_account: 'ဘဏ်အကောင့်',
        order_remark: 'မှတ်ချက်',
        ...
        missing_trade_no: 'အော်ဒါနံပါတ် ပျောက်ဆုံးနေသည် ',
